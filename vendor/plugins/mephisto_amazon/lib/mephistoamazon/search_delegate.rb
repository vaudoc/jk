...
module MephistoAmazon
  class SearchDelegate
    ...
    def initialize
      dev_token = Mephisto::Plugin[:amazon].amazon_dev_token
      ass_id = Mephisto::Plugin[:amazon].amazon_associate_id 
      @request = Amazon::Search::Request.new(dev_token, ass_id, 'de')
